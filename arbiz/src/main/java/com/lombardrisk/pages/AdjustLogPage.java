...
public class AdjustLogPage extends AbstractPage
{
	 ...
	 */
	public RejectionsPage enterRejectionsPage() throws Exception
	{
		element("alp.rejectTabBtn").click();
		waitStatusDlg();
		return new RejectionsPage(getWebDriverWrapper());
	}

	/**
	 * Navigate to allocation page
	 */
	public AllocationPage enterAllocationPage() throws Exception
	{
		element("alp.allocTabBtn").click();
		waitStatusDlg();
